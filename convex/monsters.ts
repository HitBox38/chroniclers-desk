...
export const create = mutation({
  args: {
    ...
    armorClass: v.number(),
    speed: v.string(),
    speedSwim: v.optional(v.string()),
    speedFly: v.optional(v.string()),
    speedBurrow: v.optional(v.string()),
    speedClimb: v.optional(v.string()),
    speedHover: v.optional(v.boolean()),
    strength: v.number(),
    dexterity: v.number(),
  ...
  handler: async (ctx, args) => {
    ...
    const monster = await ctx.db.insert("monsters", {
      ...
      speed: {
        ...
        swim: args.speedSwim,
        fly: args.speedFly,
        burrow: args.speedBurrow,
        climb: args.speedClimb,
        hover: args.speedHover,
      },
