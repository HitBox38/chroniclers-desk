...
export const TagsContent = ({ className, children, ...props }: TagsContentProps) => {
  ...
  return (
    <PopoverContent
      className={cn("p-0 z-[60] flex flex-col", className)}
      style={{ width, maxHeight: "300px" }}
      {...props}>
      <Command className="flex flex-col overflow-hidden" shouldFilter loop={false}>
        {children}
      </Command>
    </PopoverContent>
  );
...
export const TagsList = ({ className, ...props }: TagsListProps) => {
  ...
  return (
    <CommandList
      className={cn("!overflow-y-scroll !overflow-x-hidden overscroll-contain", className)}
      style={{
        touchAction: "pan-y",
        maxHeight: "250px",
...
export const TagsGroup = ({ className, ...props }: TagsGroupProps) => (
  <CommandGroup
    className={cn("!overflow-visible !h-auto", className)}
    style={{ height: "auto" }}
    {...props}
  />
);
